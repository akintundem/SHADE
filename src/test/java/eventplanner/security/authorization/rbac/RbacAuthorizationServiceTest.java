...
class RbacAuthorizationServiceTest {
    ...
    void setUp() {
        ...
        authorization = new RbacAuthorizationService(policyStore, authorizationService, taskRepository, attendeeRepository, attendeeInviteRepository, ticketRepository);
    }
