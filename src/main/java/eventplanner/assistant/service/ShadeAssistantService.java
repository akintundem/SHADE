...
import eventplanner.assistant.validation.JsonSchemaValidator;
...
public class ShadeAssistantService {
    ...
    private AssistantChatResponse parseAssistantResponse(JsonNode json) {
        ...
        if (json.has("structured_response") && !json.get("structured_response").isNull()) {
            var sr = new eventplanner.assistant.dto.StructuredResponseDTO();
            ...
            if (srNode.has("venue_cards")) {
                var list = new java.util.ArrayList<eventplanner.assistant.dto.VenueCardDTO>();
                for (JsonNode v : srNode.get("venue_cards")) {
                    var vc = new eventplanner.assistant.dto.VenueCardDTO();
            ...
            // chips
            if (srNode.has("chips")) {
                var list = new java.util.ArrayList<eventplanner.assistant.dto.ChipDTO>();
                for (JsonNode c : srNode.get("chips")) {
                    var chip = new eventplanner.assistant.dto.ChipDTO();
            ...
            if (srNode.has("action_buttons")) {
                var list = new java.util.ArrayList<eventplanner.assistant.dto.ActionButtonDTO>();
                for (JsonNode b : srNode.get("action_buttons")) {
                    var ab = new eventplanner.assistant.dto.ActionButtonDTO();
