...
export function AttendeeInvite({
  inviteeName = 'there',
  inviterName = 'Someone',
  eventName,
  message,
  ...
  return (
    <BaseLayout
      ...
      mode={mode}
    >
      <Heading style={styles.title(colors)}>You're invited</Heading>
      <Text style={styles.paragraph(colors)}>
        Hi {inviteeName}, {inviterName} invited you to{' '}
      ...
      <Text style={styles.muted(colors)}>
        You can respond anytime before the invitation expires.
      </Text>
    </BaseLayout>
  )
}
